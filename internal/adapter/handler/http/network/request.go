...
func ReqBody[T any](ctx *gin.Context, dto port.Dto[T]) (*T, error) {
...
// func ReqQuery[T any](ctx *gin.Context, dto port.Dto[T]) (*T, error) {
...
func ReqParams[T any](ctx *gin.Context, dto port.Dto[T]) (*T, error) {
...
// func ReqHeaders[T any](ctx *gin.Context, dto port.Dto[T]) (*T, error) {
...
// func processErrors[T any](dto port.Dto[T], err error) error {
